...
The user's default personal or business bank account and other private information are in the files represented by the files in the 'resources' directory:
  ...
  * 'user-account-data.hjson' Contains the bank account data. 

  * 'user-register.json' Contains records of checks written.

  * 'user-check-data.hjson' Contains the data to define the physical layout of a printed check.
